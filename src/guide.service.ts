...
export class GuideService {
  private witnessTexts: Record<string, string> = {
    ...
    'motor-fest-card': "Motor Fest 2023 ghi dấu khả năng solo hậu kỳ: áp lực thời gian cùng với phân chia công việc giữa Công ty và Freelance, Minato biến hỗn loạn thành phản xạ, sử dụng thời gian hợp lý để có thể đáp ứng nhu cầu của các đối tác. Tiến độ vận hành như phương trình α² + β² = 𝝅², mỗi chặng là một hạng tử trong ∑ αᵢ.",
    'digital-identity-card': "Latent ID 𝑍Σ̴𝐑Ø là Anchor Point cho MinatoRootSystemObject<br>└ Binary Sig 1010₂→10₁₀ minh hoạ thuật toán chuyển cơ số<br>└ GitHub là node định danh, sync theo Codex<br>└ Repo 'hello-world' là Genesis.Block – là core logic bất biến cùng với checkpoint 𝑉𝐸𝐿𝑉𝐸𝑇.𝑅𝑂𝑂𝑀.𝟺:𝟸𝟶.",
    ...
    'hithegioi-card': "Toàn bộ hậu kỳ do Minato trực tiếp thực hiện, đảm bảo từ xử lý kỹ thuật đến hoàn thiện sáng tạo. Nhịp dựng bám sát đồ thị ∑ αᵢβᵢ ↗, từng layer tiến gần 𝝅.",
